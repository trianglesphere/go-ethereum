...
type StateDB interface {
	...
	GetCode(context.Context, common.Address) []byte
	SetCode(context.Context, common.Address, []byte)
	GetCodeSize(context.Context, common.Address) int
	...
	Suicide(context.Context, common.Address) bool
	HasSuicided(context.Context, common.Address) bool

	// Exist reports whether the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(context.Context, common.Address) bool
	// Empty returns whether the given account is empty. Empty
	// is defined according to EIP161 (balance = nonce = code = 0).
	Empty(context.Context, common.Address) bool
